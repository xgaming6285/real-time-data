                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center bg-white/5 rounded-xl p-1 border border-white/10">
                      ...
                      >
                        ...
                        <span
                          className={`tabular-nums text-xs ${
                            mode === "demo" ? "text-amber-300" : "text-gray-500"
                          }`}
                        >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        {activeTradingAccount && (
                          <div
                            ...
                            style={{
                              backgroundColor: `${
                                (
                                  activeTradingAccount as TradingAccountWithBalances
                                ).color || "#3b82f6"
                              }30`,
                              borderColor: `${
                                (
                        ...
                        <div className="relative">
                          <div
                            className={`w-8 h-8 sm:w-9 sm:h-9 rounded-full flex items-center justify-center transition-all bg-linear-to-br from-cyan-400 to-blue-500 ${
                    ...
                    <button
                      ...
                      className={`w-8 h-8 rounded-full transition-all ${
                        newAccountColor === color
                          ? "ring-2 ring-white ring-offset-2 ring-offset-[#1c202e]"
                          : ""
                      }`}
                ...
                >
                  ...
                  {tradingAccounts.map((ta) => (
                    <option key={ta._id} value={ta._id}>
                      ...
                      {formatBalance(
                        transferMode === "live"
                          ? ta.balances.live.balance
                          : ta.balances.demo.balance
                      )}
                      )
                    </option>
                  ))}
